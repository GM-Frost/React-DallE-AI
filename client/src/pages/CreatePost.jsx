...
const CreatePost = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#003753] text-[32px]'>Create</h1>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='m-10'>
          ...
          >Once you have create the image you wnat, you can share it with others in the community</p>

          <button type='submit'
            className='mt-3 text-white bg-[#003753] hover:bg-[#dea247] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'
